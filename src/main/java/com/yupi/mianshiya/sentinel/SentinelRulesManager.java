...
public class SentinelRulesManager {
    ...
    public void initFlowRules() {
        // 单 IP 查看题目列表限流规则
        ParamFlowRule rule = new ParamFlowRule(SentinelConstant.LIST_QUESTION_VO_BY_PAGE)
    ...
    public void initDegradeRules() {
        // 单 IP 查看题目列表熔断规则
        DegradeRule slowCallRule = new DegradeRule(SentinelConstant.LIST_QUESTION_VO_BY_PAGE)
        ...
        DegradeRule errorRateRule = new DegradeRule(SentinelConstant.LIST_QUESTION_VO_BY_PAGE)
