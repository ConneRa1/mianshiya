...
public class QuestionBankServiceImpl extends ServiceImpl<QuestionBankMapper, QuestionBank> implements QuestionBankService {
    ...
    public void validQuestionBank(QuestionBank questionBank, boolean add) {
        ...
        // 创建数据时，参数不能为空
        if (add) {
//            ThrowUtils.throwIf(questionBank.getId()==null, ErrorCode.PARAMS_ERROR);
//            ThrowUtils.throwIf(questionBank.getUserId()==null, ErrorCode.PARAMS_ERROR);
                ThrowUtils.throwIf(questionBank.getTitle()==null, ErrorCode.PARAMS_ERROR);
//            ThrowUtils.throwIf(questionBank.getDescription()==null, ErrorCode.PARAMS_ERROR);
//            ThrowUtils.throwIf(questionBank.getPicture()==null, ErrorCode.PARAMS_ERROR);
        }
        // 修改数据时，有参数则校验
